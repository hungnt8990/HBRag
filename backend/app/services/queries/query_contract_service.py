...
INTENT_ARTIFACT_TYPES: dict[DetectedIntent, list[str]] = {
    "identifier_lookup": ["identifier_lookup", "document_profile", "document_summary_artifact"],
    "person_assignment": ["person_assignment_artifact", "table_row_artifact", "assignment_artifact", "table_evidence_artifact"],
    "procedure_lookup": ["procedure_artifact", "table_row_artifact", "document_profile", "table_evidence_artifact", "document_summary_artifact"],
    "policy_rule_lookup": ["policy_rule_artifact", "table_row_artifact", "legal_evidence_artifact", "table_evidence_artifact"],
    "table_lookup": ["table_row_artifact", "person_assignment_artifact", "policy_rule_artifact", "procedure_artifact", "table_evidence_artifact", "assignment_artifact", "legal_evidence_artifact"],
    "general_summary": ["document_profile", "policy_rule_artifact", "procedure_artifact", "table_row_artifact", "document_summary_artifact", "legal_evidence_artifact", "table_evidence_artifact"],
}
